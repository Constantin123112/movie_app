  ...
  Iterable<Object?> serialize(Serializers serializers, AppState object,
    ...
    final result = <Object?>[
      ...
      serializers.serialize(object.films,
          specifiedType: const FullType(FilmsState)),
      'comments',
      ...
      switch (key) {
        ...
        case 'films':
          result.films.replace(serializers.deserialize(value,
              specifiedType: const FullType(FilmsState))! as FilmsState);
          break;
        case 'comments':
...
class _$AppState extends AppState {
  ...
  _$AppState._(
      {required this.auth, required this.films, required this.comments})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(auth, r'AppState', 'auth');
    BuiltValueNullFieldError.checkNotNull(films, r'AppState', 'films');
    BuiltValueNullFieldError.checkNotNull(comments, r'AppState', 'comments');
  }
  ...
  int get hashCode {
    return $jf(
        $jc($jc($jc(0, auth.hashCode), films.hashCode), comments.hashCode));
  }
...
class AppStateBuilder implements Builder<AppState, AppStateBuilder> {
  ...
  FilmsStateBuilder? _films;
  FilmsStateBuilder get films => _$this._films ??= new FilmsStateBuilder();
  set films(FilmsStateBuilder? films) => _$this._films = films;
